...
function Error404({ data }) {
  ...
  return (
    <>
      <Header header={header} headerMenus={headerMenus} />
      <div className="h-almost-screen">
        <section className="text-gray-600 body-font">
          <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
            <div className="lg:flex-grow md:w-1/1 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center flex justify-center">
